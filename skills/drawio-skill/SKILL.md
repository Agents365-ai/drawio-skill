...
| `scripts/pyimports.py` · `jsimports.py` · `goimports.py` | The user wants to visualize a **Python, JS/TS, or Go project** structure — extracts the import graph (transitive-reduced, optional `--group` containers, nested by sub-package) for autolayout |
